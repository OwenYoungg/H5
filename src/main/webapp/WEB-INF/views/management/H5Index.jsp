            ...
            <div class="row">
                <form class="form-horizontal" role="form" id="h5Form">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input id="title" name="title" type="text" class="form-control" placeholder="必填，长度4~20"/>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						    <input type="text" class="form-control" value="2017-01" id="datetimepicker" name="datetimepicker">
